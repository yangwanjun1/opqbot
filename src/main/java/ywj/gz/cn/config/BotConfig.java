...
public class BotConfig {
    ...
    public WsSocketClient webSocketClient(ApplicationContext context) throws URISyntaxException {
        ...
        QQEventHandler handler = new QQEventHandler(properties,compressImage,cacheImage,poolExecutor());
        URI uri = new URI(properties.getWs());
        return new WsSocketClient(uri,  context, handler,properties.getCheckTime(),properties.getSelfId());
    }
